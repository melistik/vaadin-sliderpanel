...
public class SliderPanelBuilder {
    ...
    protected List<SliderPanel.SliderPanelToggleListener> listeners = null;
     ...
     *
     * @param listener instance of {@link SliderPanel.SliderPanelToggleListener}
     * @return builder
     */
    public SliderPanelBuilder listener(final SliderPanel.SliderPanelToggleListener listener) {
     ...
     *
     * @param style style that should get add to each nodes of {@link VSliderPanel}<br>
