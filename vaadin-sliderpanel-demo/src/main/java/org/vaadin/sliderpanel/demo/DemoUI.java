...
public class DemoUI extends UI {
    ...
    protected void init(final VaadinRequest vaadinRequest) {
        ...
        enabledCheckBox.addValueChangeListener(event -> firstTopSlider.setEnabled(enabledCheckBox.getValue()));
        ...
        final SliderPanel bottomSlider =
    ...
    private Grid genGrid() {
        ...
        // init Container
        final BeanItemContainer<Inhabitants> container = new BeanItemContainer<Inhabitants>(Inhabitants.class,
    ...
    private Component genInfo() {
        ...
        final Label details = new Label("<h3>Vaadin SliderPanel</h3>"
